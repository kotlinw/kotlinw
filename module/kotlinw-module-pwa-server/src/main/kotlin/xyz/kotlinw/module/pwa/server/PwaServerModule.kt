...
import xyz.kotlinw.pwa.ResourceWebPathLookup
import xyz.kotlinw.pwa.WebResourceRegistrant
...
class PwaServerModule {
    ...
    @Singleton(binds = [WebResourceRegistry::class, ResourceWebPathLookup::class]) // TODO https://github.com/InsertKoinIO/koin/issues/1681
